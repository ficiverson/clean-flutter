...
class FlightAnimation extends StatefulWidget {
  ...
  @override
  _FlightAnimationState createState() => new _FlightAnimationState();
}
...
class _FlightAnimationState extends State<FlightAnimation>
  ...
  void initState() {
    ...
    animationBackground = new CurvedAnimation(
        parent: _controller, curve: new ElasticOutCurve(0.6));
  ...
  Widget build(BuildContext context) {
    return new Stack(
      ...
      children: <Widget>[
        new CustomPaint(
          painter: new BackgroundPainter(
              animationBackground.value < 0
                  ? animationBackground.value
                  : 1 - animationBackground.value,
              new Offset(200.0, 150.0)),
          child: new Container(
